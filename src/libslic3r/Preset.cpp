...
static std::vector<std::string> s_Preset_print_options {
    "layer_height", "first_layer_height", "perimeters", "spiral_vase", "internal_structure_top_points", "internal_structure_wave_length", "internal_structure_wave_height", "slice_closing_radius", "slicing_mode",
